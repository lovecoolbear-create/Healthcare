<template>
  <div v-if="loading" class="flex flex-col items-center justify-center py-20">
    ...
    <span class="text-sm text-slate-400 mt-4">加载中...</span>
  </div>
  ...
  <div v-else class="space-y-4">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
      <div class="flex items-center gap-4">
        <div class="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center font-black text-white text-xl">
        ...
        <div class="px-3 py-1.5 rounded-full text-xs font-bold" :class="riskClass">
    ...
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
      ...
      <div v-if="profile.inventory?.lowStockItems?.length > 0" class="mt-3 space-y-1">
    ...
    <!-- 亮点 -->
    <div v-if="profile.strengths?.length" class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-5 border border-emerald-100">
    ...
    <!-- 改进点 -->
    <div v-if="profile.improvements?.length" class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-5 border border-amber-100">
      <div class="flex items-center gap-2 mb-3">

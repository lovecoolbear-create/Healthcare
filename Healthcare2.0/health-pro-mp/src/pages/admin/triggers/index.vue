<template>
  <view>
    <!-- #ifdef H5 -->
    <DesktopTriggers v-if="isDesktop" />
    <!-- #endif -->
    ...
    <view v-if="!isDesktop" class="mp-page-shell min-h-screen bg-transparent flex flex-col items-center justify-center p-10 text-center">
      ...
      <text class="text-slate-500 text-sm">干预触发器配置功能仅支持在 PC 端操作，以获得最佳体验。</text>
      <button
        @click="goBack"
...
// #ifdef H5
import DesktopTriggers from './components/DesktopTriggers.vue';
// #endif
